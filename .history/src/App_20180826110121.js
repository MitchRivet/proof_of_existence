  ...
  instantiateContract() {
    ...
    this.state.web3.eth.getAccounts((error, accounts) => {
      proofs.deployed().then((instance) => {
        ...
        debugger; 
        return proofsInstance.createProof('inital proof', 'here is my proof', 'eventualImage.jpg', ["first", "time"], {from: accounts[0]});
      }).then((result) => {
        //get proof index 0... want to figure out how to get ALL proofs at init, i.e. return an array of structs 
        debugger; 
        return proofsInstance.getProof.call(accounts[0])
      }).then((result) => {
